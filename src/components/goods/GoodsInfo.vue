...
<script>
    ...
    // 导入 数字选择框 组件
    import numbox from "../common/goodsinfo_numbox";
    ...
    export default {
        ...
        methods: {
                ...
                this.$axios.get("http://47.89.21.179:8080/api/getthumimages/" + this.id).then(result => {
                    if (result.data.status === 0) {
                        ...
                        result.data.message.forEach(item => {
                            item.img = 'https://img14.360buyimg.com/n1/s546x546_jfs/t21694/230/2633176357/135133/aa48d211/5b600d47Nadbe9b39.jpg';
                        });
            ...
            getGoodsInfo() {
                // 获取商品的信息
                this.$axios.get("http://47.89.21.179:8080/api/goods/getinfo/" + this.id).then(result => {
                    if (result.data.status === 0) {
