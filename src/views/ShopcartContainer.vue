...
<script>
    import numbox from "../components/common/shopcar_numbox";
    ...
    export default {
        ...
        methods: {
            getGoodsList() {
                ...
                // 获取购物车商品列表
                this.$axios
                    .get("http://47.89.21.179:8080/api/goods/getshopcarlist/" + idArr.join(","))
                    .then(result => {
                        ...
                        this.goodslist.push({
                            id: 87,
                            thumb_path: 'https://img14.360buyimg.com/n0/jfs/t18796/84/1058770765/167120/6a4d3002/5ab9e73fN4a360e8a.jpg',
                            title: "小米MIX2S",
                            sell_price: 2599
                        });
                        this.goodslist.push({
